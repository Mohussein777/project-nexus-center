...
import { employees, getCurrentEmployeeStatus } from './employeeData';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        <div className="text-center sm:text-right">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-400">الإجمالي: 28 موظف في 5 أقسام</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredEmployees.map((employee) => {
          ...
          const timeStatus = getCurrentEmployeeStatus(employee.id);
